...
public class ProductController {
    ...
    public Result<IPage<ProductListItemResponse>> getProductList(
        ...
        IPage<ProductListItemResponse> productPage = productService.getProductListWithImages(
                page, size, categoryId, minPrice, maxPrice, status, sortType);
    ...
    public Result<IPage<ProductListItemResponse>> searchProducts(
        ...
        IPage<ProductListItemResponse> productPage = productService.searchProductsWithFilters(
                page, size, keyword, minPrice, maxPrice, sortType);
        return Result.success(productPage);
    }
}
